"""This file contains classes for I/O with video."""
...
class VideoWriter(cv2.VideoWriter):
    ...
    def __init__(self, reader: VideoReader, save_path: str):
        """Create new writer object with properties from reader object.
        ...
        super().__init__(
            save_path, cv2.VideoWriter_fourcc("m", "p", "4", "v"), fps, size
        )
